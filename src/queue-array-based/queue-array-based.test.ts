import { Queue } from "./queue-array-based";
...
describe("Queue Array Based", () => {
  describe("enqueue", () => {
    ...
    it("shoud resize if reaching the end of the capacity", () => {
      const q = new Queue<number>(5, 1, 2, 3, 4, 5);
      q.enqueue(6);
  ...
  describe("dequeue", () => {
    ...
    it("should remove data from the queue and return its value", () => {
      const q = new Queue<number>(16, 1, 2, 3);
